          ...
          child: Column(
            ...
            children: [
              FilledButton.icon(
                ...
                label: const Text('Paste Invoice Rows'),
              ),
              const SizedBox(height: 10),
              const Text(
                'Paste client, date, time/duration, and KM rows. The entry date places each row into the correct fortnight/invoice period.',
      ...
      builder: (context, scrollController) {
        return ListView(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            const Text(
              'One row per support entry. Use comma, pipe, or tab-separated text.',
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                ...
                hintText:
                    'Client A, 02/05/2026, 9:00-11:30, 24km, Wellbeing support',
