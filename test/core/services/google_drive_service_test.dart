...
void main() {
  ...
  test(
    ...
    () async {
      ...
      expect(
        meta.folderOpenLink,
        contains('client-notes%2FJane%20Smith%2FInvoice%205'),
      );
      ...
      final api = _FakeGoogleDriveApi(
        childrenByParent: {
          ...
          'client-folder': [
            const GoogleDriveFile(
              id: 'period-folder',
              name: 'Invoice 5 - 2026-05-31 to 2026-06-13',
              mimeType: 'application/vnd.google-apps.folder',
            ),
          ],
          'period-folder': [
      ...
      final api = _FakeGoogleDriveApi(
        childrenByParent: {
          ...
          'client-folder': [
            const GoogleDriveFile(
              id: 'period-folder',
              name: 'Invoice 5 - 2026-06-01 to 2026-06-14',
              mimeType: 'application/vnd.google-apps.folder',
            ),
          ],
          'period-folder': [
  ...
  test(
    ...
    () async {
      ...
      expect(result.file.name, contains('Invoice 5 2026-05-31 to 2026-06-13'));
    ...
    () async {
      ...
      final docsApi = _FakeGoogleDocsApi(
        tabs: [
          ...
          _FakeGoogleDocTab(
            id: 'invoice-tab',
            title: 'Invoice 5 2026-05-31 to 2026-06-13',
          ),
          _FakeGoogleDocTab(
            id: 'type-tab-new',
            title: 'Texts - Inv 5',
    ...
    () async {
      final api = _FakeGoogleDriveApi(
        childrenByParent: {
          ...
          'client-folder/Invoice 5 - 2026-05-31 to 2026-06-13/Home Visits': [
            const GoogleDriveFile(
              id: 'existing-google-doc',
              name: '2026-06-02_Jane_Smith_incomplete',
              mimeType: _googleDocsMimeType,
  ...
  test('saveSupportNote converts an existing docx into a Google Doc', () async {
    ...
    final meta = await service.saveSupportNote(
      ...
      existingMeta: const EntryDriveSupportNoteMeta(
        ...
        noteText: 'Old note',
        mimeType: _docxMimeType,
        parentFolderId: 'client-notes/AB/Invoice 5 - 2026-06-01 to 2026-06-14',
      ),
    );
    ...
    () async {
      ...
      final meta = await service.saveSupportNote(
        ...
        existingMeta: const EntryDriveSupportNoteMeta(
          ...
          mimeType: _docxMimeType,
          parentFolderId:
              'client-notes/AB/Invoice 5 - 2026-06-01 to 2026-06-14',
